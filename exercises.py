...
def apply_discount(price, disc_percent):
    new_price = price - (price * disc_percent / 100)
    return new_price
...
def largest(n1, n2, n3):
    return max(n1, n2, n3)
print('Exercise 6:', largest(91, 33, 45))
...
#
# Define the function and then call it below.
def basicCalculator(num1, num2, operand):
    if operand.lower() == "add":
        return num1 + num2
    elif operand.lower() == "subtract":
        return num1 - num2
    elif operand.lower() == "multiply":
        return num1 * num2
    elif operand.lower() == "divide":
        return num1 / num2
print('Exercise 9:', basicCalculator(10, 5, 'divide'))
